                            ...
                            <div class="projects-holder">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="{{url('assets')}}/img/portfolio_big_item_01.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_01.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix animation">
                                      <div class="thumb">
                                        <div class="image">
                                                <a href="{{url('assets')}}/img/portfolio_big_item_02.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_02.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix branding">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="{{url('assets')}}/img/portfolio_big_item_03.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_03.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix graphic nature">
                                        <div class="thumb">
                                            <div class="image">
                                                <a href="{{url('assets')}}/img/portfolio_big_item_04.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_04.jpg"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix branding">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="{{url('assets')}}/img/portfolio_big_item_05.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_05.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix graphic animation">
                                        <div class="thumb">
                                            <div class="image">
                                                <a href="{{url('assets')}}/img/portfolio_big_item_06.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_06.jpg"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
