...
<div class="row justify-content-center">
      ...
      @endif
      <form action="{{route('add.trans')}}" method="post">
      @csrf
        <!-- input -->
         <div class="row">
            <div class="col-lg-6">
            <label for="nc" class="col-form-label">Client</label>
            <select name="client" id="client" class="itemName form-control" required></select>
            <label for="np" class="mt-1 col-form-label">Bilboard</label>
            <select name="bilboard" id="bil" class="itemName form-control" required> </select>
            <label class="mt-1 col-form-label">Kontrak</label>
            <input type="text" id="dtp" name="kontrak" class="form-control" required>
            <label class="mt-1 col-form-label">Mulai Tayang</label>
            <input type="text" id="dtp1" name="mulai_tayang" class="form-control" required>
            <label class="mt-1 col-form-label">Akhir Tayang</label>
            <input type="text" id="dtp2" name="akhir_tayang" class="form-control" required>
            </div>
            <div class="col-lg-6">
                <div class="row mt-4">
                 <div class="col-12">
                 <img src="https://img.icons8.com/metro/100/000000/no-camera.png" id="imgView" alt="" class="img-fluid">         
                 </div>
                </div>
                <dt>Detail Client</dt>
                <dd id="namaP"></dd>
